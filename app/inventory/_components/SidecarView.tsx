...
import { Copy, Check, ChevronRight, ChevronLeft, Send, ExternalLink, Code, Globe, Facebook, LayoutTemplate } from 'lucide-react';
...
const SidecarView: React.FC<SidecarViewProps> = ({ items, onMarkAsListed }) => {
...
<div style="border:1px solid #e2e8f0; border-radius:12px; overflow:hidden; max-width:400px; font-family:sans-serif;">
  <img src="${getDisplayUrl(currentItem.imageUrl) || ''}" alt="${currentItem.title}" style="width:100%; height:auto; display:block;">
        ...
        <div className="max-w-4xl mx-auto space-y-6 pb-20">
            ...
            <div className="flex gap-4">
                ...
                <div className="ml-auto flex gap-2">
                    {currentItem.websiteParams?.slug && (
                        <a
                            href={productPath(currentItem.websiteParams.slug)}
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
                ...
                <div className="relative h-64 md:h-96">
                    <img src={getDisplayUrl(currentItem.imageUrl) || ''} alt={currentItem.title} className="w-full h-full object-contain" />
                ...
                <div className="px-8 pb-8">
                    <button
                        onClick={() => onMarkAsListed(currentItem.id)}
