const PROVIDER_CAPABILITIES = {
  'dlpartsco.com': {
    ...
    reason: 'D&L catalog route requires browser/manual extraction; no deterministic BOM adapter is registered.',
  },
  'encompass.com': {
    availability: 'requires_manual_review',
    reason: 'Encompass pricing/model URL support exists, but no deterministic exploded-view BOM adapter is registered.',
  },
